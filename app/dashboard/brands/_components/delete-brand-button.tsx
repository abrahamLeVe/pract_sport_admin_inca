...
export function DeleteBrandButton({
  ...
  const handleDelete = () => {
    startTransition(async () => {
      const result = await actions.brands.deleteBrandAction(brandId);
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Estás a punto de eliminar la marca <b>"{brandName}"</b>. Esta acción
            borrará el registro de la base de datos y destruirá la imagen
